...
<body background="https://wallpaperscraft.com/image/lines_dark_light_form_background_47106_3840x2160.jpg">
  ...
  <div class="mdl-grid" align="center">
    ...
    <div class="mdl-cell mdl-cell--8-col">
      <h4 style="color: white"><i><b>CHANNEL PARTNER FORM</b></i></h4>
      <div class="demo-card-wide mdl-card mdl-shadow--2dp cardsize" style="height:400px">
        <!-- Textfield with Floating Label -->
        
        <form action="<?php echo base_url('channel/postChannel') ?>">
         
         
          <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
            <input class="mdl-textfield__input" type="text" id="sample3" name="name">
            <label class="mdl-textfield__label" for="sample3">Advisor Name</label>
          </div>
          <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
          <input class="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id="sample4" name="mobile">
          <label class="mdl-textfield__label" for="sample4">Advisors Mobile No. </label>
          <span class="mdl-textfield__error">Input is not a number!</span>
        </div>
          <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label" >
            <input class="mdl-textfield__input" type="email" id="sample3" name="email">
            <label class="mdl-textfield__label" for="sample3">Advisor Email Id</label>
          </div>
          
          <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
            <input class="mdl-textfield__input" type="text" id="sample3" name="pan">
            <label class="mdl-textfield__label" for="sample3">Advisors PAN Number</label>
          </div>
          <div class="mdl-select mdl-js-select mdl-select--floating-label">
            <select class="mdl-select__input" id="professsion"   name="selectreg">
              <option value=""></option>
              <option value="option1">YES</option>
              <option value="option2">NO</option>
             
            </select>
            <label class="mdl-select__label" for="professsion">Do you wish to register your SME client  </label>
          </div>
        <div>
