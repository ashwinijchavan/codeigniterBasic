...
<body background="https://wallpaperscraft.com/image/lines_dark_light_form_background_47106_3840x2160.jpg">
		...
		<div class="mdl-grid" align="center">
            ...
            <div class="mdl-cell mdl-cell--8-col">
                    <h4 style="color: white"><i><b>ENQUIRY FORM</b></i></h4>
				    <div class="demo-card-wide mdl-card mdl-shadow--2dp cardsize">
						<!-- Textfield with Floating Label -->
 
						<form action="<?php echo base_url('enquiry/postEnquiry') ?>">
						  ...
						  <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label" >
						    <input class="mdl-textfield__input" type="email" id="sample3" name="mail">
              ...
              <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                <input class="mdl-textfield__input" type="text" id="sample3" name="message">
