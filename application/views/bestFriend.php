		...
		<div class="mdl-grid" align="center">
            ...
            <div class="mdl-cell mdl-cell--8-col">
				    ...
				    <div class="demo-card-wide mdl-card mdl-shadow--2dp cardsize">
						...
						<form action="<?php echo base_url('friend/postFriend') ?>">
 
			              <div style="height:50px">
						  	
						  </div>
						  <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
						    <input class="mdl-textfield__input" type="text" id="sample3" name="name1">
						    <label class="mdl-textfield__label" for="sample3">Frnd  name 1</label>
						  </div>
						  <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label" >
						    <input class="mdl-textfield__input" type="text" id="sample3" name="name2">
						    <label class="mdl-textfield__label" for="sample3">Frnd Name 2</label>
						  </div>
						  <div style="height:50px">
